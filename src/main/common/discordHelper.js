...
var DiscordHelper = /** @class */ (function () {
    ...
    DiscordHelper.getUserId = function (authorisationToken) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, oauth.getUser(authorisationToken)["catch"](logger.error)];
                    case 1:
                        data = _a.sent();
    ...
    DiscordHelper.getUser = function (auth) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                logger.debug("DiscordHelper get user with auth " + auth);
                return [2 /*return*/, oauth.getUser(auth)["catch"](logger.error)];
            });
        });
    };
