...
class ExtendedMessage extends APIMessage {
  resolveData () {
...
class Message extends Structures.get('Message') {
  inlineReply (content, options) {
    return this.channel.send(ExtendedMessage.create(this, content, options, { replyTo: this }).resolveData())
  }

  edit (content, options) {
    return super.edit(ExtendedMessage.create(this, content, options).resolveData())
  }
}
