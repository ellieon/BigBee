...
exports["default"] = express.Router()
    ...
    .get('/discord-callback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, oauth.tokenRequest({
                        code: req.query.code,
                        grantType: 'authorization_code'
                    })];
            case 1:
                data = _a.sent();
                token = jwtHelper_1.JwtHelper.createBearerToken(data.access_token);
                jwtHelper_1.JwtHelper.saveBearerTokenToCookie(res, token);
                res.redirect(environmentHelper_1.EnvironmentHelper.getBaseURL() + "/" + req.query.state);
                return [3 /*break*/, 3];
            case 2:
                err_1 = _a.sent();
                logger.error(err_1);
