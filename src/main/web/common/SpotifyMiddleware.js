...
var SpotifyMiddleware = /** @class */ (function () {
    function SpotifyMiddleware() {
    }
    SpotifyMiddleware.requestHandler = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var db, userId, connection;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        db = new database_1.DatabaseHelper();
                        return [4 /*yield*/, discordHelper_1.DiscordHelper.getUserId(res.locals.SESSION_ID)];
                    case 1:
                        userId = _a.sent();
                        return [4 /*yield*/, db.getSpotifyKeyForUser(userId)];
                    case 2:
                        connection = _a.sent();
                        if (!connection) {
                            logger.info('No spotify token found');
                            res.redirect(environmentHelper_1.EnvironmentHelper.getBaseURL() + "/spotify-login");
                        }
                        next();
                        return [2 /*return*/];
                }
