...
var COMMAND_STRING = /^bee!search(?:\s(?<songName>.+))?$/;
var NAME = 'bee!search search <song name>';
var DESCRIPTION = 'Searches for a song on Spotify and echoes the result';
var Search = /** @class */ (function (_super) {
    ...
    Search.prototype.execute = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            var params, data, name_1, artist;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        params = message.content.match(COMMAND_STRING).groups.songName;
                        ...
                        return [4 /*yield*/, this.helper.searchForTrack(params, message.author.id)];
                    case 1:
                        data = (_a.sent()).body.tracks.items;
                        if (data.length === 0) {
                            ...
                            message.channel.send("I found the song `" + name_1 + " by " + artist + "` when searching for `" + params + "`")["catch"](logger.error);
                            this.checkReactMessage(message);
                        }
                        return [2 /*return*/];
                }
