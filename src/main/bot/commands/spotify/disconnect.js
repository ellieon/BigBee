...
var COMMAND_STRING = /^bee!disconnect$/;
var NAME = 'bee!disconnect';
var DESCRIPTION = 'Disconnects the user from Spotify';
    ...
    Disconnect.prototype.execute = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.deleteUser(message.author.id)["catch"](function () {
                            _this.crossReactMessage(message);
